...
function abg_rp_inner_box( $post ) {
	...
	switch ($pinType) {
		case 'movie':
		    ...
		    $movieForm = '
		        <p>
		        	<label for="abg_rp_pinName">Enter the title of the movie *</label><br/>
		        	<input type="text" id="abg_rp_pinName" name="abg_rp_pinName" value="'.esc_attr($pinName).'" size="30" />
		        </p>
		        <p>
		        	<label for="abg_rp_pinDescription">Enter the movie description</label><br/>
		        	<input type="text" id="abg_rp_pinDescription" name="abg_rp_pinDescription" value="'.esc_attr($pinDescription).'" size="30" />
		        </p>
		        <p>
		...
		case 'product':
		    ...
		    print('
		        ...
		        <p>
		        	<label for="abg_rp_pinDescription">Enter the product description</label><br/>
		        	<input type="text" id="abg_rp_pinDescription" name="abg_rp_pinDescription" value="'.esc_attr($pinDescription).'" size="30" />
		        </p>
		        <p>
		        ...
		        <p>
					...
					<option value="OnlineOnly" '.selected( $pinAvailability, "OnlineOnly", false).'>online only</option>					<option value="OutOfStock" '.selected( $pinAvailability, "OutOfStock", false).'>out of stock</option>
		...
		case 'recipe':
		    ...
		    $recipeForm = '
		        <p>
		        	<label for="abg_rp_pinName">Enter the recipe name *</label><br/>
		        	<input type="text" id="abg_rp_pinName" name="abg_rp_pinName" value="'.esc_attr($pinName).'" size="30" />
		        </p>
		        <p>
		        	<label for="abg_rp_pinDescription">Enter the recipe description</label><br/>
		        	<input type="text" id="abg_rp_pinDescription" name="abg_rp_pinDescription" value="'.esc_attr($pinDescription).'" size="30" />
		        </p>
		        <p>
